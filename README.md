...
| 版本 | 日期 | 说明 |
| --- | --- | --- |
| **v1.5** | 2026-09-12 | 新增**专注锁**：计时期间挡住短视频、游戏等分心应用（电话短信不受影响） |
| v1.4 | 2026-09-12 | 专注页瘦身：删掉与统计页重复的小卡、两排胶囊合并成一个科目选择器、内容垂直居中 |
| v1.3 | 2026-09-12 | 换成简笔画风格新图标（含 Android 13+ 单色主题图标） |
| v1.2 | 2026-09-12 | 新增**数据备份与恢复**（换手机/升级不丢数据，与网页版通用）；修复计时中切换科目会把时长记错科目 |
| v1.1 | 2026-09-12 | 修复：「我的」页提示文字重叠；修复从旧版升级后科目细分项没被自动补上的问题 |
| v1.0 | 2026-09-12 | 首个版本：番茄计时、科目细分、圆盘统计、锁屏计时、CSV 导出 |

> **建议所有用户升级到 v1.2**，并尽快用「我的 → 数据 → 备份全部数据」做一次备份。
>
